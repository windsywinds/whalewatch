...
const MobileMenu = ({ onLogin, onLogout, handleComponentChange}) => {
  ...
  return(
    ...
    <div className="w-screen h-[65px] sm:h-[10vw] lg:hidden bg-[#282c34] sticky bottom-0 left-0 z-10 grid grid-cols-5 divide-x border-t-2 text-white text-xs">
      ...
      <button className="flex flex-col items-center" onClick={() => handleComponentChange('submit')}>
      <div className="h-full flex flex-col items-center justify-center">
      ...
      <button className="flex flex-col items-center" onClick={() => handleComponentChange('display')}>
      <div className="h-full flex flex-col items-center justify-center">   
      ...
      <button className="flex flex-col items-center" onClick={() => handleComponentChange('resources')}>
      <div className="h-full flex flex-col items-center justify-center">
