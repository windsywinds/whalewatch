    ...
    return(
        ...
        <div className="flex flex-col text-center pb-2">
          <p className="text-lg px-2 pb-6 my-auto">
            ...
            {storedAlertSetting && storedAlertSetting !== "null" && (
            ...
            <p className="flex w-full py-2 items-center justify-center">If you're having issues with alerts, please try disabling them, logging out, and then delete and reinstall the app to reset it. If problems persist, please get in touch using the feedback section. </p>
...
export const SetUserAlertLocation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const confirmRegion = await getTokenAndSubscribe("Auckland", latitude, longitude, range);
